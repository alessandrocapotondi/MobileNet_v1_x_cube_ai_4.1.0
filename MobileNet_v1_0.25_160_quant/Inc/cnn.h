...
#define AI_CNN_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 160, 160, 3, 1, NULL), \
}
#define AI_CNN_IN_SIZE { \
  (160 * 160 * 3), \
}
#define AI_CNN_IN_1_SIZE  (160 * 160 * 3)
#define AI_CNN_IN_1_SIZE_BYTES  ((160 * 160 * 3) * 1)
...
#define AI_CNN_OUT_1_SIZE_BYTES  ((1 * 1 * 1001) * 1)
